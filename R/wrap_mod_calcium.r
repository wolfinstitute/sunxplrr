#' @title Runs the sunxplrr modules for the calcium image analysis
#'
#' @description Runs the sunxplrr modules for the exploration of calcium images 
...
message("  sunxplrr::mod_fits_import ", param.lst$inp_file_name,
